  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (isAcceptingMessagesStatus?.data?.isAcceptingMessages === true) {
        ...
        setAcceptConditionError("User do not accept messages");
        toast({
          title: "Error",
          description: "User do not accept messages",
          variant: "destructive",
        });
      }
    } catch (error) {
    ...
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {acceptConditionError ? (
          <p className="text-sm text-red-500">User do not accept messages</p>
        ) : (
        ...
        <div className=" mt-1 mb-3">
          <textarea
            ...
            placeholder="Write your anonoymous message here"
            {...register("message")}
          ></textarea>
          {errors?.message && (
